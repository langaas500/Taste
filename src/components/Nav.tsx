...
const strings = {
  no: { forYou: "For deg", together: "Se sammen", search: "Søk", library: "Mine titler", profile: "Profil", settings: "Innstillinger", guest: "Gjest", login: "Logg inn", filmelsker: "Filmelsker", togetherTagline: "Hva skal dere se?", togetherSub: "Finn noe å se sammen — på under 3 minutter", togetherCta: "Se sammen", guides: "Utforsk guider" },
  en: { forYou: "For You", together: "Watch Together", search: "Search", library: "My Titles", profile: "Profile", settings: "Settings", guest: "Guest", login: "Log in", filmelsker: "Film lover", togetherTagline: "What should you watch?", togetherSub: "Find something to watch together — in under 3 minutes", togetherCta: "Watch Together", guides: "Explore guides" },
  dk: { forYou: "For dig", together: "Se sammen", search: "Søg", library: "Mine titler", profile: "Profil", settings: "Indstillinger", guest: "Gæst", login: "Log ind", filmelsker: "Filmelsker", togetherTagline: "Hvad skal I se?", togetherSub: "Find noget at se sammen — på under 3 minutter", togetherCta: "Se sammen", guides: "Udforsk guider" },
  se: { forYou: "För dig", together: "Se tillsammans", search: "Sök", library: "Mina titlar", profile: "Profil", settings: "Inställningar", guest: "Gäst", login: "Logga in", filmelsker: "Filmälskare", togetherTagline: "Vad ska ni se?", togetherSub: "Hitta något att se tillsammans — på under 3 minuter", togetherCta: "Se tillsammans", guides: "Utforska guider" },
  fi: { forYou: "Sinulle", together: "Katso yhdessä", search: "Hae", library: "Omat nimikkeet", profile: "Profiili", settings: "Asetukset", guest: "Vieras", login: "Kirjaudu", filmelsker: "Elokuvarakastaja", togetherTagline: "Mitä katsotte?", togetherSub: "Löydä jotain katsottavaa yhdessä — alle 3 minuutissa", togetherCta: "Katso yhdessä", guides: "Tutustu oppaisiin" },
} as const;
      ...
      >
        ...
        >
          ...
          <nav className="flex-1 px-2 pt-3 pb-2 overflow-y-auto" style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {navItems.map(({ href, label, icon, authRequired }) => {
