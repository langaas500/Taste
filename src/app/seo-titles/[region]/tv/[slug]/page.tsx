...
export async function generateMetadata({
  ...
  const ogImage = isMatch
    ? buildMatchOgImageUrl(title.title, title.poster_path, title.year, "tv")
    : buildOgImageUrl(title.title, title.poster_path, title.year, "tv", title.vote_average, providerName);
