...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: canonical,
      type: "video.tv_show",
      images: [{ url: buildOgImageUrl(title.title, title.poster_path, title.year, "tv", title.vote_average), width: 1200, height: 630 }],
    },
    twitter: {
      card: "summary_large_image",
      title: displayTitle,
      description: description.slice(0, 200),
      images: [buildOgImageUrl(title.title, title.poster_path, title.year, "tv", title.vote_average)],
    },
  };
}
