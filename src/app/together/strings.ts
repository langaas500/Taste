...
const strings = {
  ...
  intro: {
    ...
    groupLabel: { no: "Group", en: "Group" },
    groupDesc: { no: "Nyhet · 3–7 spillere", en: "New · 3–7 players" },
    hasCode: { no: "Jeg har en kode", en: "I have a code" },
    headline: { no: "Finn noe å se sammen", en: "Find something to watch together" },
    subtext: { no: "Ingen diskusjon. Bare match.", en: "No debate. Just match." },
