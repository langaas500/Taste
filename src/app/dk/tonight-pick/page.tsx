...
export const metadata: Metadata = {
  title: "Tonight's Pick — Dagens filmanbefalning til par | Logflix",
  description: "Hver aften vælger Logflix en film og en serie tilpasset din og din partners smag. Premium-funktion for par der elsker film.",
  ...
  openGraph: { title: "Tonight's Pick — Dagens filmanbefalning til par | Logflix", description: "Hver aften vælger Logflix en film og en serie tilpasset din og din partners smag.", url: "https://logflix.app/dk/tonight-pick" },
};

export default function TonightPickPage() {
  const schema = { "@context": "https://schema.org", "@type": "SoftwareApplication", name: "Logflix Tonight's Pick", applicationCategory: "EntertainmentApplication", operatingSystem: "Web", url: "https://logflix.app/dk/tonight-pick", featureList: ["Daglig filmanbefalning", "Par-tilpasset", "Tonight's Pick"], offers: { "@type": "Offer", price: "29", priceCurrency: "DKK", description: "Logflix Premium" } };
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", color: "#fff", padding: "80px 24px 60px" }}>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 17, lineHeight: 1.7, color: "rgba(255,255,255,0.7)", marginBottom: 20 }}>Hver aften vælger Logflix en film og en serie — tilpasset din og din partners smag. Ingen scrolling, ingen diskussioner. Bare tryk play.</p>
