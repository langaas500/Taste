...
function SettingsContent() {
  ...
  return (
    <div className="animate-fade-in-up space-y-4">
      ...
      {/* Mobile-only quick nav for pages not in bottom bar */}
      <div className="md:hidden grid grid-cols-3 gap-2 mb-2">
        {[
          ...
          { href: "/taste", label: "Smaksprofil", icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" },
          ...
          <Link
            key={href}
            href={href}
            className="flex flex-col items-center gap-1.5 py-3 rounded-xl bg-white/[0.04] border border-white/[0.06] active:bg-white/[0.08] transition-all"
          >
