    ...
    <div style={{ minHeight: "100vh", background: "#0a0a0f", color: "#fff", padding: "80px 24px 60px" }}>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          <a href="/together" style={{ display: "inline-block", padding: "14px 28px", borderRadius: 12, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", color: "rgba(255,255,255,0.7)", fontSize: 15, fontWeight: 500, textDecoration: "none" }}>Se Premium-fördelar</a>
        </div>
      </div>
    </div>
  );
