...
const s = {
  no: {
    ...
    s9p1: "Det finnes foreløpig ikke selvbetjent sletting i appen.",
    s9p2: "For å slette konto og alle tilhørende data, send e-post til:",
  ...
  en: {
    ...
    s9p1: "There is currently no self-service deletion in the app.",
    s9p2: "To delete your account and all associated data, send an email to:",
